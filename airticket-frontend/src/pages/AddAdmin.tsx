  ...
  {users.map((user) => (
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete User <b>{user.userId}-{user.firstName} {user.lastName}</b>? This action cannot be undone.
            </DialogDescription>
          </DialogHeader>
    ...
    <TableRow key={user.userId}>
      ...
      <TableCell className="text-right gap-4 flex justify-end">
        {user.role==="CUSTOMER" && <Button size="lg" onClick={() => handleAddAdmin(user)} >
               Make Admin
              </Button>}
